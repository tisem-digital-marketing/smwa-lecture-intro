...
* **Lectures**
  * Recorded Lectures - Discussion of papers & marketing concepts
      - *Not* in-person
  * Live Computer Lectures - Methods intros, biweekly
      - *In person, on campus*
...
* Dutch, Esch Based (very small, Boxtel more familiar)
  * But studied at Tilburg and been working here for almost a year
...
* **Format**:
  ...
  - Afterwards: Write a short individual reflection on how it went

*Topics are available on the course website 2 weeks before a presentation*
